...
public class UserNameFragment extends Fragment {
    ...
    private void initUI() {
        nameEditWrapper = view.findViewById(R.id.regNameWrapper);
        regNameEdit = view.findViewById(R.id.regNameEdit);
        Button buttonUserName = view.findViewById(R.id.buttonUserNameNext);
